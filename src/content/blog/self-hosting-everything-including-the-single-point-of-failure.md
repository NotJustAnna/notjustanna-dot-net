...
And for a while, it works beautifully. Ansible (yes, Ansible, I've since retired it, but that's [another post](/post/containers-the-wrong-way-lessons-learnt/)) kept everything converging to the right state. ArgoCD synced my apps from a Forgejo repo. Kubectl reached K3s over Headscale. Users — well, me — logged into Forgejo via Keycloak OIDC. My custom Keycloak theme was hosted on Forgejo.
